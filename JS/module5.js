...
// const averageScore = students.reduce((totalScore, currentScore) => {
//   totalScore += currentScore.score;
//   return totalScore;
// }, 0) / students.length;
// console.log(averageScore)

// const lowScore = students.filter(student => student.score < 85).toSorted((a, b) => a.score - b.score);
// console.log(lowScore);

// const totalHighScore = students.filter(student => student.score < 85).reduce((total, currentScore) => {
//   total += currentScore.score;
//   return total;
// }, 0)
// console.log(totalHighScore);

// const checkScore = students.every(student => student.score > 90);
// console.log(checkScore);

// const checkMinScore = students.some(student => student.score > 90);
// console.log(checkMinScore);
